...
- Index files list all entries with links
- Back-navigation: `[← Back to Index](index.md)`

---

## Validation

Run `_scripts/audit-structure.sh` to validate all files against these schemas.
Run `_scripts/audit-links.sh` to check all internal links.
