...
Reads grails/*.md frontmatter and generates:
  ...
  - _data/grails.jsonl  (structured data export)

Usage: python3 _scripts/generate-grails.py
"""
...
JSONL_OUT = REPO_ROOT / "_data" / "grails.jsonl"

TIMESTAMP = datetime.now(timezone.utc).strftime("%Y-%m-%dT%H:%M:%SZ")
HEADER = f"<!-- generated: {TIMESTAMP} by _scripts/generate-grails.py -->"
